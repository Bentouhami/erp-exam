...
export async function POST(req: NextRequest) {
    ...
    try {
        await transporter.sendMail({
            ...
            to: email,
            subject: 'Welcome to ERP - GestFact - Verify Your Email Address',
            html: `
                <!DOCTYPE html>
                <html lang="en">
                <head>
                    ...
                    <title>Verify Your Email - ERP - GestFact</title>
                </head>
                <body style="
                    margin: 0;
                    padding: 0;
                    ...
                    ">
                        ...
                        ">
                            <h2 style="
                                ...
                                font-weight: bold;
                                text-align: center;
                            ">Welcome to ERP - GestFact, ${name}!</h2>
                            ...
                            <p style="
                                ...
                                margin-bottom: 25px;
                                text-align: center;
                            ">Thank you for joining ERP - GestFact. To get started, please verify your email address.</p>
                        ...
                        ">
                            <p style="margin: 5px 0;">
                                This email was sent by ERP - GestFact
                            </p>
                            <p style="margin: 5px 0;">
